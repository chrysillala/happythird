...
.requires(
	...
	'impact.timer',
	// 'impact.debug.debug' // debugger tool
)
...
.defines(function(){
	...
	MyGame = ig.Game.extend({
		...
		draw: function() {
			...
			if(this.instructText){
				...
				this.instructText.draw('Find the Door', 
					x, y-50, ig.Font.ALIGN.CENTER);
	...
	StartScreen = ig.Game.extend({
		instructText: new ig.Font('media/04b03.font.png'),
		background: new ig.Image('media/screen-bg-4.jpg'),

		mainCharacter: new ig.Image('media/couple.png'),
		title: new ig.Image('media/third.png'),
		...
		draw: function(){
			...
			this.mainCharacter.draw(50,125);
			this.title.draw(ig.system.width/2-60, 0);
			var x = ig.system.width/2,
			y = ig.system.height - 10;
